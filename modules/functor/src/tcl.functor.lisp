...
(definstance (functor io)
  ((fmap (f io)
     `(make-instance 'io-action
                     :instance (lambda () (funcall ,f (funcall ,io)))
                     :type '(io *)))))
